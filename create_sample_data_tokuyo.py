...
def create_sample_data():
    ...
    for staff in staff_data:
        ...
        # employee_idを生成
        existing_count = StaffMember.objects.count()
        employee_id = f"T{date.today().year}{existing_count + 1:04d}"
    ...
    print(f"  合計: {req2_count}件の要件Ⅱを作成")
    ...
    if created:
        ...
        if initiatives.exists():
            ...
            print(f"  ✓ 職場環境等要件を{initiatives.count()}件選択")
        else:
            print(f"  ⚠ 職場環境等要件が見つかりません")
    else:
        print(f"  ✓ 処遇改善計画書を確認")
